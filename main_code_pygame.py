...
crash_sound = pygame.mixer.Sound("pause.wav")
...
def game_intro():
    ...
    while intro:
        ...
        global pause
        button("Sound Clip-1",200,200,80,50,black,black,slow1)
        button("Sound Clip-2",200,300,80,50,black,black,slow1)
        button("Sound Clip-3",200,400,80,50,black,black,slow1)
...
def game_loop():
    ...
    if (List3[9]=="jj") :
        ...
        output_wavefile = time_scale(List1,List2)
        pygame.display.update()
        List3[9] = ["j"]
        pygame.display.update()
